<?php
    ...
    while (true) {
        ...
        $answer   = json_decode(file_get_contents('https://api.vk.com/method/messages.send?user_id='. $user_id . '&random_id=' . $random_id . '&peer_id='. $peer_id . '&message=' . $message . '&group_id=' . $group_id . '&v=5.101&access_token=' . $token));
